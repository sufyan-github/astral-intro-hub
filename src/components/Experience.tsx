...
// ================================================
// JSON‑DRIVEN EXPERIENCE SECTION
// Data file: src/data/experience.json (example provided separately)
...
type ExperienceItem = {
  ...
  company: string;
  location: string;
  period: string; // free text, e.g., "Mar 2024 – Present"
  website?: string; // e.g., "aibd.ai" or full URL
  supervisor?: string;
  description: string[];
  featured?: boolean;
};
